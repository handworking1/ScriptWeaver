...
export function ScriptsPage() {
  ...
  const GENRE_CATEGORIES = [
    { label: '主要题材', tags: ['言情', '玄幻', '仙侠', '悬疑', '科幻', '奇幻', '脑洞', '都市', '历史', '古言', '无CP'] },
    { label: '核心情节', tags: ['重生', '穿越', '穿书', '系统', '无限流', '复仇', '升级流'] },
    { label: '热门设定', tags: ['爽文', '屌丝逆袭', '废柴流', '打脸爽文', '追妻火葬场', '马甲文', '真假千金', '迪化文', '发疯文学', '虐文', 'CP塑造'] },
    { label: '背景职业', tags: ['种田', '宫斗', '末世', '娱乐圈', '总裁', '灵异', '赛博朋克', '商战', '冒险'] },
  ];
