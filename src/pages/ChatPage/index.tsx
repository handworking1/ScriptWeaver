...
export function ChatPage() {
  ...
  const { build1v1Prompt, buildWorldPrompt, buildGroupPrompt } = useSystemPrompt(chatMode, character, script, templates, activeTemplateId, replyLength, interactionOpts, playAs, narrativePerson, groupCharacterIds, observerMode);
